...
class Game:
    ...
    def move_snake(self):
        ...
        head.change_values(self.real_position(self.snake_position),True)
    ...
    def change_apple_position(self):
        ...
        while(True):
            ...
            if(not self.real_position(rand) in not_posibilites):
                position=rand
                break
            i+=1
        ...
        for i in not_posibilites:
            print(i[0]/38,i[1]/38)"""
        for i in self.apple:
            i.change_values(self.real_position(position))
    ...
    def init_apple(self):
        ...
        apple.change_values(self.real_position(position))
    ...
    def mainloop(self):
        while(True):
            ...
            if(self.is_paused and not self.is_dead):
                ...
                self.game_over.render(self.screen, self.real_position([self.x_max/2,(self.y_max/2)*1.75]))
            
            self.score_title.render(self.screen,self.real_position([self.x_max*0.8,1]))
    ...
    def createBlock(self,coordenade,color):
        ...
        sprites.change_values(self.real_position(coordenade))
